...
import static grafic.Rectangel.*;

public class AppRectangel {
    public static void main(String[] args) {
        System.out.println("This program uses a rectangle.");
       Rectangel rect = new Rectangel(20,25);
        Rectangel rect2 = new Rectangel();
        ...
        System.out.println("Area: " + rect2.getArea());
        System.out.println("Perimeter: " + rect2.getPerimeter());
     System.out.println(Rectangel.ANGLES);
